...
<html lang="tr">
  <head>
    ...
    <title>Mozaik</title>
    <!-- TEMA ÖNYÜKLEMESİ. Ertelenmez ve etmemeli: ayrıştırmayı bloklayan
         bu betik olmadan karanlık tema kayıtlıyken ilk kare açık zeminle
         boyanıyor, çünkü aşağıdaki modül belge ayrıştırmasından sonra
         koşuyor. Üç dize theme.ts ile aynı olmak zorunda ve bunu
         src/preferences.test.ts ölçüyor. Gerekçe docs/BUILD.md'de. -->
    <script>
      var t = null;
      try {
        t = localStorage.getItem('ders-programi-tema');
      } catch (e) {
        /* depo kapalı ya da dolu olabilir, tema yine de kurulur */
      }
